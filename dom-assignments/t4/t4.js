...
function success(pos) {
  ...
  const omaPaikka = [coords.longitude, coords.latitude];
  console.log(omaPaikka);

  console.log(distance(omaPaikka, restaurants[1].location.coordinates));

 
  restaurants.sort(function (a, b) {
    return (
      distance(omaPaikka, a.location.coordinates) -
      distance(omaPaikka, b.location.coordinates)
    );
  });
